...
def VideoSpatialPrediction(
    ...
    for i in range(num_samples):
        ...
        #img_file = os.path.join(vid_name, 'frame{0:05d}.jpg'.format(i*step+1))
    ...
    # rgb_1 = rgb[:256, :256, :,:]
    # rgb_2 = rgb[:256, -256:, :,:]
    # rgb_3 = rgb[0:256, 42:298, :,:]
    # rgb_4 = rgb[-256:, :256, :,:]
    # rgb_5 = rgb[-256:, -256:, :,:]
    # rgb_f_1 = rgb_flip[:256, :256, :,:]
    # rgb_f_2 = rgb_flip[:256, -256:, :,:]
    # rgb_f_3 = rgb_flip[0:256, 42:298, :,:]
    # rgb_f_4 = rgb_flip[-256:, :256, :,:]
    # rgb_f_5 = rgb_flip[-256:, -256:, :,:]

    rgb_1 = rgb[:256, :256, :,:]
    rgb_2 = rgb[:256, -256:, :,:]
    rgb_3 = rgb[8:264, 52:308, :,:]
    rgb_4 = rgb[-256:, :256, :,:]
    rgb_5 = rgb[-256:, -256:, :,:]
    rgb_f_1 = rgb_flip[:256, :256, :,:]
    rgb_f_2 = rgb_flip[:256, -256:, :,:]
    rgb_f_3 = rgb_flip[8:264, 52:308, :,:]
    rgb_f_4 = rgb_flip[-256:, :256, :,:]
    rgb_f_5 = rgb_flip[-256:, -256:, :,:]
