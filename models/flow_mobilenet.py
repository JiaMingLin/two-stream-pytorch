...
__all__ = ['MobileNetV2', 'mobilenet_v2', 'flow_mobilenet']
...
class MobileNetV2(nn.Module):
    def __init__(self,
        ...
        features = [ConvBNReLU(20, input_channel, stride=2)]
...
#      width_mult = 0.75
#      model = flow_mobilenet(pretrained=True, num_classes=101, width_mult = width_mult)
